...
| Module system | ✅ Loader works | ✅ **198 std modules** | Compile + load via module loader |
| REPL | ✅ Works | ✅ Gerbil syntax | Uses gherkin for compilation |
| Test suite | **385 checks** | ✅ All pass | Compilation + loader + functionality |
...
**Test harness:** `tests/self-host-core.ss` — 385/385 checks pass
