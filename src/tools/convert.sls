        ...
        (lambda (imp)
          (let ((s (symbol->string imp)))
            (cond
              ...
              ((string-prefix? ":std/net/request" s) (hashtable-set! needs 'net-request #t))
              ((string-prefix? ":std/net/httpd" s) (hashtable-set! needs 'net-httpd #t))
              ((string-prefix? ":std/net/ssl" s) (hashtable-set! needs 'net-ssl #t))
              ((string-prefix? ":std/net/bio" s) (hashtable-set! needs 'net-bio #t))
              ((or (string-prefix? ":std/text/zlib" s)
                   (string-prefix? ":std/compress" s))
               (hashtable-set! needs 'compress-zlib #t))
              ((string-prefix? ":std/crypto/digest" s) (hashtable-set! needs 'crypto-digest #t))
              ((string-prefix? ":std/crypto" s) (hashtable-set! needs 'crypto-digest #t))
              ((string-prefix? ":std/text/base64" s) (hashtable-set! needs 'text-base64 #t))
              ((string-prefix? ":std/text/hex" s) (hashtable-set! needs 'text-hex #t))
              ((string-prefix? ":std/text/utf8" s) (hashtable-set! needs 'text-utf8 #t))
              ((string-prefix? ":std/text/csv" s) (hashtable-set! needs 'text-csv #t))
              ((string-prefix? ":std/misc/ports" s) (hashtable-set! needs 'misc-ports #t))
              ((string-prefix? ":std/misc/bytes" s) (hashtable-set! needs 'misc-bytes #t))
              ((string-prefix? ":std/misc/uuid" s) (hashtable-set! needs 'misc-uuid #t))
              ((string-prefix? ":std/misc/repr" s) (hashtable-set! needs 'misc-repr #t))
              ((string-prefix? ":std/misc/alist" s) (hashtable-set! needs 'misc-alist #t))
              ((string-prefix? ":std/misc/queue" s) (hashtable-set! needs 'misc-queue #t))
              ((string-prefix? ":std/os/temporaries" s) (hashtable-set! needs 'os-temporaries #t))
              ((string-prefix? ":std/os/env" s) (hashtable-set! needs 'os-env #t))
              ((string-prefix? ":std/os/path" s) (hashtable-set! needs 'os-path #t))
              ((string-prefix? ":std/logger" s) (hashtable-set! needs 'logger #t))
              ((string-prefix? ":std/srfi/13" s) (hashtable-set! needs 'srfi-13 #t))
              ((string-prefix? ":std/srfi/19" s) (hashtable-set! needs 'srfi-19 #t))
              ((string-prefix? ":std/xml" s) (hashtable-set! needs 'xml #t))
              ((string-prefix? ":std/test" s) (hashtable-set! needs 'test #t))
              ((string-prefix? ":std/db" s) (hashtable-set! needs 'db-dbi #t))
              ((string-prefix? ":std/stxutil" s) (hashtable-set! needs 'stxutil #t))
              ((string-prefix? ":std/sync" s)
               (cond
                 ((string-contains s "completion") (hashtable-set! needs 'sync-completion #t))
                 ((string-contains s "channel") (hashtable-set! needs 'sync-channel #t))
                 (else (hashtable-set! needs 'sync-completion #t))))
              ;; New: misc modules
              ((string-prefix? ":std/misc/number" s) (hashtable-set! needs 'misc-number #t))
              ((string-prefix? ":std/misc/list-builder" s) (hashtable-set! needs 'misc-list-builder #t))
              ((string-prefix? ":std/misc/func" s) (hashtable-set! needs 'misc-func #t))
              ((string-prefix? ":std/misc/shuffle" s) (hashtable-set! needs 'misc-shuffle #t))
              ((string-prefix? ":std/misc/plist" s) (hashtable-set! needs 'misc-plist #t))
              ((string-prefix? ":std/misc/deque" s) (hashtable-set! needs 'misc-deque #t))
              ((string-prefix? ":std/misc/pqueue" s) (hashtable-set! needs 'misc-pqueue #t))
              ((string-prefix? ":std/misc/rbtree" s) (hashtable-set! needs 'misc-rbtree #t))
              ((string-prefix? ":std/misc/walist" s) (hashtable-set! needs 'misc-walist #t))
              ((string-prefix? ":std/misc/vector" s) (hashtable-set! needs 'misc-vector #t))
              ((string-prefix? ":std/misc/atom" s) (hashtable-set! needs 'misc-atom #t))
              ((string-prefix? ":std/misc/channel" s) (hashtable-set! needs 'sync-channel #t))
              ((string-prefix? ":std/misc/completion" s) (hashtable-set! needs 'sync-completion #t))
              ((string-prefix? ":std/misc/timeout" s) (hashtable-set! needs 'misc-timeout #t))
              ((string-prefix? ":std/misc/threads" s) (hashtable-set! needs 'misc-threads #t))
              ((string-prefix? ":std/misc/rwlock" s) (hashtable-set! needs 'misc-rwlock #t))
              ((string-prefix? ":std/misc/wg" s) (hashtable-set! needs 'misc-wg #t))
              ;; New: values, assert, lazy, coroutine
              ((string-prefix? ":std/values" s) (hashtable-set! needs 'values #t))
              ((string-prefix? ":std/assert" s) (hashtable-set! needs 'assert #t))
              ((string-prefix? ":std/lazy" s) (hashtable-set! needs 'lazy #t))
              ((string-prefix? ":std/coroutine" s) (hashtable-set! needs 'coroutine #t))
              ;; New: net modules
              ((string-prefix? ":std/net/uri" s) (hashtable-set! needs 'net-uri #t))
              ((string-prefix? ":std/net/websocket" s) (hashtable-set! needs 'net-websocket #t))
              ((string-prefix? ":std/net/s3" s) (hashtable-set! needs 'net-s3 #t))
              ((string-prefix? ":std/net/address" s) (hashtable-set! needs 'net-address #t))
              ;; New: cli modules
              ((string-prefix? ":std/cli/multicall" s) (hashtable-set! needs 'cli-multicall #t))
              ((string-prefix? ":std/cli/print-exit" s) (hashtable-set! needs 'cli-print-exit #t))
              ((string-prefix? ":std/getopt" s) (hashtable-set! needs 'getopt #t))
              ;; New: text modules
              ((string-prefix? ":std/text/yaml" s) (hashtable-set! needs 'text-yaml #t))
              ((string-prefix? ":std/text/char-set" s) (hashtable-set! needs 'text-char-set #t))
              ((string-prefix? ":std/text/basic-printers" s) (hashtable-set! needs 'text-basic-printers #t))
              ;; New: crypto sub-modules
              ((string-prefix? ":std/crypto/hmac" s) (hashtable-set! needs 'crypto-hmac #t))
              ((string-prefix? ":std/crypto/cipher" s) (hashtable-set! needs 'crypto-cipher #t))
              ((string-prefix? ":std/crypto/pkey" s) (hashtable-set! needs 'crypto-pkey #t))
              ;; New: OS modules
              ((string-prefix? ":std/os/hostname" s) (hashtable-set! needs 'os-hostname #t))
              ((string-prefix? ":std/os/error" s) (hashtable-set! needs 'os-error #t))
              ((string-prefix? ":std/os/fcntl" s) (hashtable-set! needs 'os-fcntl #t))
              ((string-prefix? ":std/os/flock" s) (hashtable-set! needs 'os-flock #t))
              ;; New: SRFI modules
              ((string-prefix? ":std/srfi/43" s) (hashtable-set! needs 'srfi-43 #t))
              ((string-prefix? ":std/srfi/95" s) (hashtable-set! needs 'srfi-95 #t))
              ((string-prefix? ":std/srfi/115" s) (hashtable-set! needs 'srfi-115 #t))
              ((string-prefix? ":std/srfi/133" s) (hashtable-set! needs 'srfi-133 #t))
              ((string-prefix? ":std/srfi/141" s) (hashtable-set! needs 'srfi-141 #t))
              ;; New: parser, markup, debug
              ((string-prefix? ":std/parser" s) (hashtable-set! needs 'parser #t))
              ((string-prefix? ":std/markup" s) (hashtable-set! needs 'markup-xml #t))
              ((string-prefix? ":std/debug/DBG" s) (hashtable-set! needs 'debug-dbg #t))
              ;; New: db sub-modules
              ((string-prefix? ":std/db/leveldb" s) (hashtable-set! needs 'db-leveldb #t))
              ((string-prefix? ":std/db/conpool" s) (hashtable-set! needs 'db-conpool #t)))))
              ...
              (let ((pkg-prefix (string-append ":" (if (symbol? pkg-name) (symbol->string pkg-name) pkg-name) "/")))
                (cond
                  ...
                  ((string=? s ":std/cli/getopt")
                   (set! entries (cons '(:std/cli/getopt . (compat std-getopt)) entries)))
                  ((string=? s ":std/misc/process")
                   (set! entries (cons '(:std/misc/process . (compat std-misc-process)) entries)))
                  ((string=? s ":std/misc/ports")
                   (set! entries (cons '(:std/misc/ports . (compat std-misc-ports)) entries)))
                  ;; Network/HTTP — chez-https, chez-httpd, chez-ssl
                  ((string=? s ":std/net/request")
                   (set! entries (cons '(:std/net/request . (compat std-net-request)) entries)))
                  ((string=? s ":std/net/httpd")
                   (set! entries (cons '(:std/net/httpd . (compat std-net-httpd)) entries)))
                  ((or (string=? s ":std/net/httpd/handler")
                       (string=? s ":std/net/httpd/mux"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-net-httpd)) entries)))
                  ((string=? s ":std/net/ssl")
                   (set! entries (cons '(:std/net/ssl . (compat std-net-ssl)) entries)))
                  ((string=? s ":std/net/bio")
                   (set! entries (cons '(:std/net/bio . (compat std-net-bio)) entries)))
                  ;; Compression — chez-zlib
                  ((or (string=? s ":std/text/zlib")
                       (string=? s ":std/compress")
                       (string=? s ":std/compress/zlib"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-compress-zlib)) entries)))
                  ;; Crypto — route sub-modules to specific shims
                  ((or (string=? s ":std/crypto")
                       (string=? s ":std/crypto/digest")
                       (string=? s ":std/crypto/etc")
                       (string=? s ":std/crypto/libcrypto"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-crypto-digest)) entries)))
                  ((string=? s ":std/crypto/hmac")
                   (set! entries (cons '(:std/crypto/hmac . (compat std-crypto-hmac)) entries)))
                  ((string=? s ":std/crypto/cipher")
                   (set! entries (cons '(:std/crypto/cipher . (compat std-crypto-cipher)) entries)))
                  ((string=? s ":std/crypto/pkey")
                   (set! entries (cons '(:std/crypto/pkey . (compat std-crypto-pkey)) entries)))
                  ((string-prefix? ":std/crypto/" s)
                   (set! entries (cons (cons (string->symbol s) '(compat std-crypto-digest)) entries)))
                  ;; Text processing
                  ((string=? s ":std/text/base64")
                   (set! entries (cons '(:std/text/base64 . (compat std-text-base64)) entries)))
                  ((string=? s ":std/text/hex")
                   (set! entries (cons '(:std/text/hex . (compat std-text-hex)) entries)))
                  ((string=? s ":std/text/utf8")
                   (set! entries (cons '(:std/text/utf8 . (compat std-text-utf8)) entries)))
                  ((string=? s ":std/text/csv")
                   (set! entries (cons '(:std/text/csv . (compat std-text-csv)) entries)))
                  ;; Misc modules
                  ((string=? s ":std/misc/bytes")
                   (set! entries (cons '(:std/misc/bytes . (compat std-misc-bytes)) entries)))
                  ((string=? s ":std/misc/repr")
                   (set! entries (cons '(:std/misc/repr . (compat std-misc-repr)) entries)))
                  ((string=? s ":std/misc/alist")
                   (set! entries (cons '(:std/misc/alist . (compat std-misc-alist)) entries)))
                  ((string=? s ":std/misc/uuid")
                   (set! entries (cons '(:std/misc/uuid . (compat std-misc-uuid)) entries)))
                  ((string=? s ":std/misc/queue")
                   (set! entries (cons '(:std/misc/queue . (compat std-misc-queue)) entries)))
                  ;; OS modules
                  ((string=? s ":std/os/temporaries")
                   (set! entries (cons '(:std/os/temporaries . (compat std-os-temporaries)) entries)))
                  ((string=? s ":std/os/env")
                   (set! entries (cons '(:std/os/env . (compat std-os-env)) entries)))
                  ((string=? s ":std/os/path")
                   (set! entries (cons '(:std/os/path . (compat std-os-path)) entries)))
                  ;; Logger
                  ((string=? s ":std/logger")
                   (set! entries (cons '(:std/logger . (compat std-logger)) entries)))
                  ;; SRFIs
                  ((string=? s ":std/srfi/13")
                   (set! entries (cons '(:std/srfi/13 . (compat std-srfi-13)) entries)))
                  ((string=? s ":std/srfi/19")
                   (set! entries (cons '(:std/srfi/19 . (compat std-srfi-19)) entries)))
                  ;; XML
                  ((string=? s ":std/xml")
                   (set! entries (cons '(:std/xml . (compat std-xml)) entries)))
                  ;; Test framework
                  ((string=? s ":std/test")
                   (set! entries (cons '(:std/test . (compat std-test)) entries)))
                  ;; Database
                  ((or (string=? s ":std/db/dbi")
                       (string=? s ":std/db/sqlite")
                       (string=? s ":std/db/postgresql"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-db-dbi)) entries)))
                  ;; Sync primitives
                  ((string=? s ":std/sync/completion")
                   (set! entries (cons '(:std/sync/completion . (compat std-sync-completion)) entries)))
                  ((string=? s ":std/sync/channel")
                   (set! entries (cons '(:std/sync/channel . (compat std-sync-channel)) entries)))
                  ;; Syntax utilities
                  ((string=? s ":std/stxutil")
                   (set! entries (cons '(:std/stxutil . (compat std-stxutil)) entries)))
                  ;; Misc modules — new
                  ((string=? s ":std/misc/number")
                   (set! entries (cons '(:std/misc/number . (compat std-misc-number)) entries)))
                  ((string=? s ":std/misc/list-builder")
                   (set! entries (cons '(:std/misc/list-builder . (compat std-misc-list-builder)) entries)))
                  ((string=? s ":std/misc/func")
                   (set! entries (cons '(:std/misc/func . (compat std-misc-func)) entries)))
                  ((string=? s ":std/misc/shuffle")
                   (set! entries (cons '(:std/misc/shuffle . (compat std-misc-shuffle)) entries)))
                  ((string=? s ":std/misc/plist")
                   (set! entries (cons '(:std/misc/plist . (compat std-misc-plist)) entries)))
                  ((string=? s ":std/misc/deque")
                   (set! entries (cons '(:std/misc/deque . (compat std-misc-deque)) entries)))
                  ((string=? s ":std/misc/pqueue")
                   (set! entries (cons '(:std/misc/pqueue . (compat std-misc-pqueue)) entries)))
                  ((string=? s ":std/misc/rbtree")
                   (set! entries (cons '(:std/misc/rbtree . (compat std-misc-rbtree)) entries)))
                  ((string=? s ":std/misc/walist")
                   (set! entries (cons '(:std/misc/walist . (compat std-misc-walist)) entries)))
                  ((string=? s ":std/misc/vector")
                   (set! entries (cons '(:std/misc/vector . (compat std-misc-vector)) entries)))
                  ((string=? s ":std/misc/atom")
                   (set! entries (cons '(:std/misc/atom . (compat std-misc-atom)) entries)))
                  ((string=? s ":std/misc/channel")
                   (set! entries (cons '(:std/misc/channel . (compat std-sync-channel)) entries)))
                  ((string=? s ":std/misc/completion")
                   (set! entries (cons '(:std/misc/completion . (compat std-sync-completion)) entries)))
                  ((string=? s ":std/misc/timeout")
                   (set! entries (cons '(:std/misc/timeout . (compat std-misc-timeout)) entries)))
                  ((string=? s ":std/misc/threads")
                   (set! entries (cons '(:std/misc/threads . (compat std-misc-threads)) entries)))
                  ...
                  ((string=? s ":std/assert")
                   (set! entries (cons '(:std/assert . (compat std-assert)) entries)))
                  ((string=? s ":std/lazy")
                   (set! entries (cons '(:std/lazy . (compat std-lazy)) entries)))
                  ((string=? s ":std/coroutine")
                   (set! entries (cons '(:std/coroutine . (compat std-coroutine)) entries)))
                  ;; Net modules — new
                  ((string=? s ":std/net/uri")
                   (set! entries (cons '(:std/net/uri . (compat std-net-uri)) entries)))
                  ((string=? s ":std/net/websocket")
                   (set! entries (cons '(:std/net/websocket . (compat std-net-websocket)) entries)))
                  ((or (string=? s ":std/net/s3/sigv4")
                       (string=? s ":std/net/s3/api"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-net-s3)) entries)))
                  ((string=? s ":std/net/address")
                   (set! entries (cons '(:std/net/address . (compat std-net-address)) entries)))
                  ((string=? s ":std/net/request.ss")
                   (set! entries (cons '(:std/net/request.ss . (compat std-net-request)) entries)))
                  ;; CLI modules — new
                  ((string=? s ":std/cli/multicall")
                   (set! entries (cons '(:std/cli/multicall . (compat std-cli-multicall)) entries)))
                  ((string=? s ":std/cli/print-exit")
                   (set! entries (cons '(:std/cli/print-exit . (compat std-cli-print-exit)) entries)))
                  ((string=? s ":std/getopt")
                   (set! entries (cons '(:std/getopt . (compat std-getopt)) entries)))
                  ;; Text modules — new
                  ((string=? s ":std/text/yaml")
                   (set! entries (cons '(:std/text/yaml . (compat std-text-yaml)) entries)))
                  ((string=? s ":std/text/char-set")
                   (set! entries (cons '(:std/text/char-set . (compat std-text-char-set)) entries)))
                  ((string=? s ":std/text/basic-printers")
                   (set! entries (cons '(:std/text/basic-printers . (compat std-text-basic-printers)) entries)))
                  ((string=? s ":std/text/json/util")
                   (set! entries (cons '(:std/text/json/util . (compat json)) entries)))
                  ;; OS modules — new
                  ((string=? s ":std/os/hostname")
                   (set! entries (cons '(:std/os/hostname . (compat std-os-hostname)) entries)))
                  ((string=? s ":std/os/error")
                   (set! entries (cons '(:std/os/error . (compat std-os-error)) entries)))
                  ((or (string=? s ":std/os/fcntl")
                       (string=? s ":std/os/flock"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-os-fcntl)) entries)))
                  ;; SRFI modules — new
                  ((string=? s ":std/srfi/43")
                   (set! entries (cons '(:std/srfi/43 . (compat std-srfi-43)) entries)))
                  ((string=? s ":std/srfi/95")
                   (set! entries (cons '(:std/srfi/95 . (compat sort)) entries)))
                  ((string=? s ":std/srfi/115")
                   (set! entries (cons '(:std/srfi/115 . (compat std-srfi-115)) entries)))
                  ((string=? s ":std/srfi/133")
                   (set! entries (cons '(:std/srfi/133 . (compat std-srfi-133)) entries)))
                  ((string=? s ":std/srfi/141")
                   (set! entries (cons '(:std/srfi/141 . (compat std-srfi-141)) entries)))
                  ;; Parser, markup, debug
                  ((or (string=? s ":std/parser/ll1")
                       (string=? s ":std/parser/base"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-parser)) entries)))
                  ((or (string=? s ":std/markup/xml")
                       (string=? s ":std/markup/sxml")
                       (string=? s ":std/markup/html"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-xml)) entries)))
                  ((string=? s ":std/debug/DBG")
                   (set! entries (cons '(:std/debug/DBG . (compat std-debug-dbg)) entries)))
                  ;; Database — extended
                  ((string=? s ":std/db/conpool")
                   (set! entries (cons '(:std/db/conpool . (compat std-db-conpool)) entries)))
                  ((string=? s ":std/db/leveldb")
                   (set! entries (cons '(:std/db/leveldb . (compat std-db-leveldb)) entries)))
                  ((or (string=? s ":std/db/postgresql-driver")
                       (string=? s ":std/db/_sqlite"))
                   (set! entries (cons (cons (string->symbol s) '(compat std-db-dbi)) entries)))
                  ;; Misc aliases
                  ((string=? s ":std/string/path")
                   (set! entries (cons '(:std/string/path . (compat misc)) entries)))
                  ((string=? s ":std/list/list")
                   (set! entries (cons '(:std/list/list . (compat misc)) entries)))
                  ((string=? s ":std/hash-table")
                   (set! entries (cons '(:std/hash-table . #f) entries)))
                  ;; Skip: deeply Gerbil-specific
                  ((or (string=? s ":std/actor")
                       (string=? s ":std/generic")
                       (string=? s ":std/generic/dispatch")
                       (string=? s ":std/interface")
                       (string=? s ":std/contract")
                       (string=? s ":std/interactive")
                       (string=? s ":std/make")
                       (string=? s ":std/io")
                       (string=? s ":std/source")
                       (string=? s ":std/debug/heap"))
