#!chezscheme
;;; std-sync-completion.sls -- Compat shim for Gerbil's :std/misc/completion
;;; Asynchronous completion tokens using Chez mutex + condition variable

(library (compat std-sync-completion)
  (export
