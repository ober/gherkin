#!chezscheme
;;; std-srfi-19.sls -- Compat shim for Gerbil's :std/srfi/19
;;; Date/time handling — wraps Chez Scheme's built-in SRFI-19 support.
;;; Chez already provides most of SRFI-19 natively.

(library (compat std-srfi-19)
  (export
    current-date
    current-time
    time?
